...
if not MVCK.oLowerCondition then
    MVCK.oLowerCondition = Vehicles.LowerCondition
end

function Vehicles.LowerCondition(vehicle, part, elapsedMinutes)
    MVCK.updateVehicleCoordinate(vehicle)
	return MVCK.oLowerCondition(vehicle, part, elapsedMinutes)
end